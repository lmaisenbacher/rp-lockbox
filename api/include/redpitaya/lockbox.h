...
/**
 * Type representing the four PID controllers
 */
typedef enum {
    RP_PID_11, //!< Input A to Ouput A
    RP_PID_12, //!< Input B to Output A
    RP_PID_21, //!< Input A to Output B
    RP_PID_22  //!< Input B to Output B
} rp_pid_t;
...
* @param channel Channel which is going to be calibrated
* @return If the function is successful, the return value is RP_OK.
* If the function is unsuccessful, the return value is any of RP_E* values that indicate an error.
*/
...
* @param channel Channel A or B for which we want to set amplitude
...
* @param channel Channel A or B for which we want to get amplitude.
...
* @param channel Channel A or B for which we want to set DC offset.
...
* @param channel Channel A or B for which we want to set frequency.
...
* @param channel Channel A or B for which we want to get frequency.
...
* @param channel Channel A or B for which we want to set phase.
...
* @param channel Channel A or B for which we want to get phase.
...
* @param channel Channel A or B for which we want to set waveform type.
...
* @param channel Channel A or B for which we want to get waveform.
...
* @param channel Channel A or B for which we want to set waveform.
...
* @param channel Channel A or B for which we want to set duty cycle.
...
* @param channel Channel A or B for which we want to get duty cycle.
...
* @param channel Channel A or B for which we want to set generation mode.
...
* @param channel Channel A or B for which we want to get generation mode.
...
* @param channel Channel A or B for which we want to set number of generated waveforms in a burst.
...
* @param channel Channel A or B for which we want to get number of generated waveforms in a burst.
...
* @param channel Channel A or B for which we want to set number of burst repetitions.
...
* @param channel Channel A or B for which we want to get number of burst repetitions.
...
* @param channel Channel A or B for which we want to set burst period.
...
* @param channel Channel A or B for which we want to get burst period.
...
/**
* Sets trigger source.
* @param channel Channel A or B for which we want to set trigger source.
...
/*
 * Set the setpoint of the specified PID using the ADC calibration values stored
 * in EEPROM.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param setpoint The setpoint in V.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the setpoint of the specified PID using the ADC calibration values stored
 * in EEPROM.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param setpoint Pointer where the setpoint in V will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Set the P gain of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param kp The P gain to set. Valid values are between 0 and 4096.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the P gain of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param kp Pointer where the P gain will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Set the I gain of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param ki The I gain in 1/s to set. Valid values are between 0 and 7812499.
 * The integrator unity-gain frequency is ki/(2pi).
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the I gain of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param ki Pointer where the I gain will be returned. The integrator
 * unity-gain frequency is ki/(2pi).
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
 ...
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param enable true to enable the reset, false to disable it
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the state of the integrator reset of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param enable Pointer to a boolean that will be set true if the reset is
...
/*
 * Set the feedback sign of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param inverted true for a negative gain sign, false for a positive gain sign
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the feedback sign of the specified PID.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param inverted Pointer to a boolean that will be set true for a negative
 * gain sign and false for a positive gain sign
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Set the state of the reset when railed feature for the specified PID. When
 * enabled, the integrator will be reset when the DAC output is at the selected
 * limit.
 * @param pid The PID to use (see rp_pid_t documentation for details).
...
/*
 * Get the state of the reset when railed feature for the specified PID. When
 * enabled, the integrator will be reset when the DAC output is at the selected
 * limit.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param enable Pointer to a boolean that will be set true if the feature is
 * enabled and false otherwise
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 ...
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param enable true to turn the feature on, false to turn it off
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the status of the relock feature of the specified PID
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param enable Pointer to a boolean that will be set true if the feature is
 * enabled and false otherwise
 * @return If the function is successful, the return value is RP_OK.
...
/*
 * Get the relock stepsize of the specified PID using the ADC calibration values
 * stored in EEPROM.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param stepsize Pointer where the stepsize in V/s will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Set the minimum input voltage for which the specified PID is considered
 * locked.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param minimum The minimum voltage in V.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the minimum input voltage for which the specified PID is considered
 * locked.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param minimum Pointer where the minimum voltage in V will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Set the maximum input voltage for which the specified PID is considered
 * locked.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param maximum The maximum voltage in V.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get the maximum input voltage for which the specified PID is considered
 * locked.
 * @param pid The PID to use (see rp_pid_t documentation for details).
 * @param maximum Pointer where the maximum voltage in V will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
 ...
 * for details).
 * @param value The minimum voltage in V.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Set the maximum DAC output voltage of the specified channel using the
 * calibration values stored in EEPROM.
 * @param channel The output channel to limit (see rp_channel_t documentation
 * for details).
 * @param value The maximum voltage in V.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get minimum DAC output voltage of the specified channel using the calibration
 * values stored in EEPROM.
 * @param channel The output channel to query (see rp_channel_t documentation
 * for details).
 * @param value Pointer where the minimum voltage in V will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
...
/*
 * Get maximum DAC output voltage of the specified channel using the calibration
 * values stored in EEPROM.
 * @param channel The output channel to query (see rp_channel_t documentation
 * for details).
 * @param value Pointer where the maximum voltage in V will be returned.
 * @return If the function is successful, the return value is RP_OK.
 * If the function is unsuccessful, the return value is any of RP_E* values that
 * indicate an error.
 */
